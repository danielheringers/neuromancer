...
```
2. Evidencia de aceite esperada:
- `test real_provider_claude_code_smoke ... ok`
- comando `claude --version` retornando versao sem erro.
3. Origem do smoke test:
- `codex-rs/alicia-adapters/tests/real_provider_smoke.rs`
4. Apos executar no host alvo, atualizar este documento com o transcript resumido e remover o status de risco residual.
