...
1. Nao existe PR aberto com `head=danielheringers:neuromancer` no momento.
2. Enquanto nao houver PR, as evidencias ficam registradas neste pacote de release.
